// The implementation without d3_event_dragSuppress on drag restore. Improves performance. 
d3.svg.brush = function() {
  var event = d3_eventDispatch(brush, d3.dispatch("brushstart", "brush", "brushend")),
  ...
  function brush(g) {
    g.each(function() {
      ...
      var resize = g.selectAll(".resize")
          .data(resizes, function(d) { return d; });//d3_identity);
  ...
  brush.event = function(g) {
    g.each(function() {
      ...
      var d3_transitionInheritId = true;
...
//      dragRestore();
  ...
  brush.empty = function() {
	...
	function d3_scaleRange(scale) {
		return scale.rangeExtent ? scale.rangeExtent() : d3_scaleExtent(scale
				.range());
	}
